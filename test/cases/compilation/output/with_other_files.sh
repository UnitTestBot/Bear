...
# RUN: assert_compilation %t.json contains -file %T/with_other_files.c -files lib.o -directory %T -arguments %{c_compiler} -c lib.o -o with_other_files.o with_other_files.c
