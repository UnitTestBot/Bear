...
# RUN: assert_compilation %t.json contains -file %T/with_static_lib.c -files %T/libmy.a -directory %T -arguments %{c_compiler} -c -L. -lmy -o with_static_lib.c.o with_static_lib.c
