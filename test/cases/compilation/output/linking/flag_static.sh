...
# RUN: echo "#include \"libflag_static.h\" int foo() { return 1; }" > %T/libflag_static.c
# RUN: gcc -c %T/libflag_static.c -o %T/libflag_static.o
...
# RUN: echo "#include \"libflag_static.h\" int foo1() { return 2; }" > %T/other/libflag_static.c
# RUN: gcc -c %T/other/libflag_static.c -o %T/other/libflag_static.o
