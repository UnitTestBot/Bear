...
# RUN: assert_compilation %t.json contains -file %T/flag_wl.c -files %T/other/libmy.a %T/other/libx.a %T/other/libx.%{dynamic_lib_extension} %T/liby.%{dynamic_lib_extension} -directory %T -arguments %{c_compiler} -c -L ./other/ -Wl,-Bdynamic,-Bstatic -lmy -lx -L. -Wl,-Bdynamic -lx -ly -o flag_wl.c.o flag_wl.c
