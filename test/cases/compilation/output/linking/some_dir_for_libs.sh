...
# RUN: assert_compilation %t.json contains -file %T/some_dir_for_libs.c -files -directory %T -arguments %{c_compiler} -c -L ./other/ -L. -lmy -o some_dir_for_libs.c.o some_dir_for_libs.c
