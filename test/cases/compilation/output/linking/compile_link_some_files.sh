...
# REQUIRES: shell
# RUN: rm -f lib.o
# RUN: echo "int lib() { return 2; }" > lib.c
...
# RUN: assert_compilation %t.json contains -file %T/compile_link_some_files_1.c -files %T/lib.o -directory %T -arguments %{c_compiler} -c lib.o -o compile_link_some_files_1.c.o compile_link_some_files_1.c
# RUN: assert_compilation %t.json contains -file %T/compile_link_some_files_2.c -files %T/lib.o -directory %T -arguments %{c_compiler} -c lib.o -o compile_link_some_files_2.c.o compile_link_some_files_2.c
