...
namespace {
    ...
    {
        std::list<cs::Entry> expected = {
                { { "entry_one.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_two.c" } },
                { { "entries.c" },  std::nullopt, "/path/to", { "entries.o" }, { "cc", "-c", "-o", "entries.o", "entries.c" } },
        };
    ...
    TEST(compilation_database, entries_without_output_read_back)
    {
        ...
        std::list<cs::Entry> expected = {
                { { "entry_one.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_two.c" } },
                { { "entries.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "-o", "entries.o", "entries.c" } },
        };
    ...
    TEST(compilation_database, merged_entries_read_back)
    {
        std::list<cs::Entry> input = {
                { { "entry_one.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_two.c" } },
                { { "entry_one.c" }, std::nullopt, "/path/to", std::nullopt, { "cc1", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", std::nullopt, { "cc1", "-c", "entry_two.c" } },
        };
        std::list<cs::Entry> expected = {
                { { "entry_one.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", std::nullopt, { "cc", "-c", "entry_two.c" } },
    ...
    {
        std::list<cs::Entry> input = {
                { { "entry_one.c" }, std::nullopt, "/path/to", { "entry_one.o" }, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", { "entry_two.o" }, { "cc", "-c", "entry_two.c" } },
                { { "entry_one.c" }, std::nullopt, "/path/to/changed", { "entry_one2.o" }, { "cc1", "-c", "-o", "entry_one2.o", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to/changed", { "entry_two2.o" }, { "cc1", "-c", "-o", "entry_two2.o", "entry_two.c" } },
        };
        std::list<cs::Entry> expected = {
                { { "entry_one.c" }, std::nullopt, "/path/to", { "entry_one.o" }, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", { "entry_two.o" }, { "cc", "-c", "entry_two.c" } },
    ...
    TEST(compilation_database, duplicate_entries_file_output_read_back)
    {
        std::list<cs::Entry> input = {
                ...
                { { "entry_one.c" }, std::nullopt, "/path/to/changed", { "entry_one2.o" }, { "cc1", "-c", "-o", "entry_one2.o", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to/changed", { "entry_two2.o" }, { "cc1", "-c", "-o", "entry_two2.o", "entry_two.c" } },
                { { "entry_one.c" }, std::nullopt, "/path/to/changed", { "entry_one.o" }, { "cc1", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to/changed", { "entry_two.o" }, { "cc1", "-c", "entry_two.c" } },
        };
        std::list<cs::Entry> expected = {
                { { "entry_one.c" }, std::nullopt, "/path/to", { "entry_one.o" }, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", { "entry_two.o" }, { "cc", "-c", "entry_two.c" } },
    ...
    TEST(compilation_database, duplicate_entries_all_read_back)
    {
        std::list<cs::Entry> input = {
                { { "entry_one.c"}, std::nullopt, "/path/to", { "entry_one.o" }, { "cc", "-c", "entry_one.c" } },
                { { "entry_two.c" }, std::nullopt, "/path/to", { "entry_two.o" }, { "cc", "-c", "entry_two.c" } },
                { { "entry_three.c" }, std::nullopt, "/path/to", { "entry_three.o" }, { "cc", "-c", "entry_three.c" } },

                // Filename changed
                { { "entry_one.changed.c" }, std::nullopt, "/path/to", { "entry_one.o" }, { "cc", "-c", "entry_one.c" } },

                // Output changed
                { { "entry_two.c" }, std::nullopt, "/path/to", { "entry_two_changed.o" }, { "cc", "-c", "entry_two.c" } },

                // Flags changed
                { { "entry_three.c" }, std::nullopt, "/path/to", { "entry_three.o" }, { "cc", "-DCHANGED", "-c", "entry_three.c" } },
